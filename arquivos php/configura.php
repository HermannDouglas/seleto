...
function abrir(url) {window.open('url','width=' + 700 + ',height=' + 540 + ',top=' + Y + ',left=' + X + ',screenX=' + X + ',screenY=' + Y + ",scrollbars=yes");}
</SCRIPT>
<script> 
...
body { scrollbar-face-color: #f7fff7; scrollbar-shadow-color: black; scrollbar-highlight-color: #f7fff7; scrollbar-3dlight-color: #f7fff7; scrollbar-darkshadow-color: #f7fff7; scrollbar-track-color: "#001038"; scrollbar-arrow-color: "#001038" }
