...
<script>
   ...
   function ValidaFormulario() {
      ...
      if (document.formulario.cand_nome.value == "") {
         alert("Preencher todos os campos obrigat�rios!");
...
<style>
   ...
   body {
      ...
      scrollbar-highlight-color: #f7fff7;
      scrollbar-3dlight-color: #f7fff7;
      scrollbar-darkshadow-color: #f7fff7;
      scrollbar-track-color: "#001038";
      scrollbar-arrow-color: "#001038"
   }
